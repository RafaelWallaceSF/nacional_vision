...
function ReportsPage() {
  ...
  async function loadEmployees() { const response = await fetch('/api/employees'); setEmployees(await response.json()) }
  ...
  useEffect(() => { loadFilters().catch(() => undefined); loadGroups().catch(() => undefined); loadEmployees().catch(() => undefined); loadReport(today, '', '', 5).catch(() => undefined) }, [])
